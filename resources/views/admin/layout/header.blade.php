...
<html>
	<head>
		...
		<link
			...
			sizes="180x180"
			href="{{asset('vendors/images/favicon.png')}}"
		/>
		<link
			rel="icon"
			type="image/png"
		...
		<div class="left-side-bar">
			<div class="brand-logo">
				<a href="{{route('dashboard')}}">
					<img src="{{asset('vendors/images/logo.png')}}" alt="" class="dark-logo p-4" />
					<img
						src="{{asset('vendors/images/logo.png')}}"
						alt=""
						class="light-logo p-4"
					/>
				</a>
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						<li>
                            <a href="{{ route('dashboard') }}" class="dropdown-toggle no-arrow {{ request()->routeIs('dashboard') ? 'active' : '' }}">
                                <span class="micon bi bi-house"></span>
                                <span class="mtext">Home</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('inventory.view') }}" class="dropdown-toggle no-arrow {{ request()->routeIs('inventory.view') ? 'active' : '' }}">
                                <span class="micon bi bi-textarea-resize"></span>
                                <span class="mtext">Inventory</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('product.view') }}" class="dropdown-toggle no-arrow {{ request()->routeIs('product.view') ? 'active' : '' }}">
